...
export class smithingGame { //never change this name's syntax
    constructor(canvas,networkclient, gamepadInstance = null) {
        ...
        this.WorkshopImage.onload = () => {
            ...
            this.ctx.drawImage(this.WorkshopImage, this.pot.x, this.pot.y, this.pot.w, this.pot.h);
        };
        this.WorkshopImage.onerror = () => console.error('Failed to load image!');
...
export class SmithingItem {
   constructor(x, y, name,hits ,phases,imagePath,barImage,weaponImage,finishedCallback,psizzlesound,pHitsound){
        ...
        this.barImage.onload = () => {
            console.log(`✅ Loaded: ${imagePath}`);
        };

        this.barImage.onerror = () => {
            console.error(`❌ FAILED TO LOAD IMAGE: ${imagePath}`);
        };
        ...
        this.damage=0;
        this.phases = phases;
        this.state = this.phases.ORE;
        this.smeltsound=psizzlesound;
